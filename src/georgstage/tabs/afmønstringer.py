...
class AfmønstringTab(ttk.Frame):
    ...
    def add_item(self) -> None:
        self.registry.afmønstringer.append(Afmønstring(
            id=uuid4(),
            elev_nr=0,
            name="John Doe",
    ...
    def remove_item(self) -> None:
        ...
        self.selected_afmønstring_id = self.registry.afmønstringer[-1].id if len(self.registry.afmønstringer) > 0 else None
        self.sync_list()
        self.sync_form()
